...
\section{DONE State your research question and/or project goal(s).}
...
\section{DONE Identify the reasons for choosing the topic of interest and research question/project goal(s).}
...
\section{DONE Describe your chosen or developed research method and defend its alignment with your research question.}
...
\begin{itemize}
    ...
    \item Training of multivariate regression model (Random Forest or Gaussian Process Regression depending on time) to predict magnitude of computational error for equilibrium-based tools
...
\section{DONE What additional approval processes are required for your research? Select all that apply.}
...
\section{DONE Explain how your proposed method complies with ethical research practice.}
...
\section{DONE Describe the data or additional scholarly work that will be generated to answer your proposed research question or achieve your project goal.}
...
For any further questions, please direct to the correlated section of the pdf attached within the same Google Drive folder.
